    ...
    >
      <nav className="navbar navbar-expand-lg navbar-dark shadow-sm" style={{ background: "linear-gradient(135deg, #1e3c72 0%, #2a5298 100%)" }}>
        <div className="container-fluid px-4 py-2">
          ...
          <Link href="/TotalJobsList" className="btn btn-outline-light btn-sm rounded-pill px-3">
            Back to Jobs
          </Link>
        </div>
      </nav>
          ...
          <div className="col-lg-8">
            ...
            >
              <div className="card-header bg-white border-0 pt-4 pb-0 px-4 px-md-5">
                <h3 className="fw-bold" style={{ color: "#1e3c72" }}>Edit Job</h3>
                <p className="text-muted">Update your data source, template, or delivery schedule.</p>
              </div>

              <div className="card-body p-4 p-md-5 pt-3">
                {fetchingOptions ? (
                  <div className="text-center py-5">Loading job data...</div>
                ) : (
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="d-flex justify-content-end gap-3">
                      <Link href="/TotalJobsList" className="btn btn-light border rounded-pill px-4">
                        Cancel
                      </Link>
                      <button 
                        type="submit" 
