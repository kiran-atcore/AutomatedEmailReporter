          ...
          <div className="col-lg-8">
            ...
            >
              <div className="card-header bg-white border-0 pt-4 pb-0 px-4 px-md-5">
                <h3 className="fw-bold" style={{ color: "#1e3c72" }}>Connect New Data Source</h3>
                <p className="text-muted">Configure the connection to your external data provider.</p>
              </div>
              ...
              <div className="card-body p-4 p-md-5 pt-3">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-5">
                    ...
                    />
                    <div className="form-text">Your credentials will be encrypted securely before saving.</div>
                  </div>
