          ...
          <div className="col-lg-8">
            ...
            >
              ...
              <div className="mb-5 position-relative z-1 d-flex align-items-center gap-3">
                ...
                <div>
                  <h3 className="fw-bolder mb-1" style={{ fontFamily: "var(--font-righteous)", background: "linear-gradient(135deg, #ffffff 0%, #a1a1aa 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", fontSize: "2rem", letterSpacing: "0.5px" }}>Edit Schedule</h3>
                  <p className="theme-text-muted mb-0" style={{ fontSize: "1.1rem" }}>Update the timing rules and distribution list.</p>
                </div>
              </div>
