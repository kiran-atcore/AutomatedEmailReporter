          ...
          <div className="col-lg-8">
            ...
            >
              ...
              <div className="mb-5 position-relative z-1 d-flex align-items-center gap-3">
                <Link href="/Dashboard" className="premium-back-btn">
                  <i className="bi bi-arrow-left"></i>
                </Link>
                <div>
                  <h3 className="fw-bolder mb-1" style={{ fontFamily: "var(--font-righteous)", background: "linear-gradient(135deg, #ffffff 0%, #a1a1aa 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", fontSize: "2rem", letterSpacing: "0.5px" }}>Create New Job</h3>
                  <p className="theme-text-muted mb-0" style={{ fontSize: "1.1rem" }}>Configure your data source, template, and delivery schedule.</p>
                </div>
              </div>
              ...
              <div className="position-relative z-1">
                {fetchingOptions ? (
                  <div className="text-center py-5">
                    ...
                    <div className="text-white-50">Loading available options...</div>
                  </div>
                ) : (
                  <motion.form 
                  ...
                  >
                    ...
                    <motion.div variants={{ hidden: { opacity: 0, y: 20 }, show: { opacity: 1, y: 0, transition: { type: "spring", delay: 0.2 } } }} className="d-flex flex-column flex-md-row justify-content-md-end gap-3 pt-4 border-top border-secondary border-opacity-25">
                      <div className="btn-responsive-wrap">
                        <Link href="/Dashboard" className="btn btn-responsive premium-cancel-btn px-4 py-3 text-decoration-none shadow-sm">
                          Cancel
                        </Link>
                      </div>
                      <div className="btn-responsive-wrap">
                        ...
                        >
                          {loading ? (
                             ...
                             <><i className="bi bi-play-circle fs-5"></i> Create Job</>
                          )}
                        </button>
                      </div>
                    </motion.div>
