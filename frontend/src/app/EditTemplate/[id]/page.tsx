...
export default function EditTemplatePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      await api.put(`/reports/templates/${id}/`, formData);
          ...
          <div className="col-lg-8">
            ...
            >
              <div className="card-header bg-white border-0 pt-4 pb-0 px-4 px-md-5">
                <h3 className="fw-bold" style={{ color: "#1e3c72" }}>Edit Template</h3>
                <p className="text-muted">Update the structure and layout for your automated PDFs.</p>
              </div>
