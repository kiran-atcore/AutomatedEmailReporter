        ...
        {displayedLogs.map((log: any) => {
          ...
          return (
            <motion.div
              ...
              whileHover="hover"
              whileTap={{ scale: 0.98 }}
              className="flex-shrink-0 py-2 px-3 rounded-4 d-flex flex-column flex-md-row align-items-md-center justify-content-between position-relative overflow-hidden group mb-1"
              style={{
                cursor: "pointer",
